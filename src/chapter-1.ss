...
;; (b) During the process, `p` is evaluated n times such that theta/3^n <= 0.1.
;; Solving for n gives us n = log(10 theta)/log(3), thus the number of steps for
...
;; Iterative naive: O(n) time, O(1) space
(define (expt b n)
